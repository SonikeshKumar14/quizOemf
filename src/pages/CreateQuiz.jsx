...
const CreateQuiz = () => {
    ...
    const addQuestion = async (e) => {
        ...
        if (correctOption == undefined) {
            ...
            axios.post(`${apiURL}/examquestions/`, newQuestion).then((response) => {
    ...
    const handleOptions = ({ data, inputOption }) => {
        ...
        for (let i = 0; i < inputOption.length; i++) {
            ...
            console.log(option);
            axios.put(`${apiURL}/examquestions/` + data, option).then((response) => {
                console.log(response.status);
    ...
    const deleteQuestion = (propId) => {
        axios.delete(`${apiURL}/examquestions/` + propId).then((response) => {
            console.log(response.status);
