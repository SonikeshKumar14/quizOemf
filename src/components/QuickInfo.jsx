...
const QuickInfo = () => {
    return (
        <>
            ...
            <Container>
                <Section>
                    <Image><Person style={{ fontSize: "140px", color: "#393E46", marginLeft:"20px" }} /></Image>
                    <Info>
                ...
                <Section>
                    <Image><School style={{ fontSize: "150px", color: "#393E46", marginLeft:"20px"}} /></Image>
                    <Info>
                ...
                <Section>
                    <Image><Group style={{ fontSize: "150px", color: "#393E46", marginLeft:"20px" }} /></Image>
                    <Info>
